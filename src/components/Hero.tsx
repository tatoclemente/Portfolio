...
export function Hero() {
  ...
  return (
    <section id="top" className="grid grid-cols-1 items-center gap-10 py-14 lg:min-h-[760px] lg:grid-cols-12 lg:gap-8 lg:py-28">
      <div className="flex flex-col gap-6 lg:col-span-7 lg:gap-[30px]">
        ...
        <h1 className="display text-[52px] leading-[0.92] text-balance sm:text-7xl lg:text-[112px]">
        ...
        <p className="rise max-w-[640px] text-lg leading-relaxed text-muted lg:text-[21px]" style={{ animationDelay: "0.5s" }}>
          {hero.intro}
        </p>
      ...
      <div className="relative mx-auto flex h-[460px] w-full max-w-[420px] items-center justify-center lg:col-span-5 lg:h-[620px] lg:max-w-none">
        <div className="orbit absolute h-[340px] w-[340px] rounded-full border border-dashed border-white/20 lg:h-[560px] lg:w-[560px]">
          <span className="absolute -top-1.5 left-1/2 h-3 w-3 rounded-full bg-amber" style={{ boxShadow: "0 0 20px #f5a524" }} />
        </div>
        <div className="ring-pulse absolute h-[260px] w-[260px] rounded-full border border-white/10 lg:h-[400px] lg:w-[400px]" />
        <div className="orbit-rev absolute h-[300px] w-[300px] rounded-full border border-dashed border-amber/35 lg:h-[480px] lg:w-[480px]">
          <span className="absolute -bottom-[5px] left-1/2 h-2.5 w-2.5 rounded-full bg-violet" style={{ boxShadow: "0 0 18px #b45cff" }} />
        </div>

        <div className="tilt relative h-[300px] w-[236px] rounded-[26px] p-[2px] lg:h-[380px] lg:w-[300px] lg:rounded-[28px]" style={{ background: "linear-gradient(160deg, #f5a524, #b45cff 60%, #1f6bff)", boxShadow: "0 40px 100px rgba(180,92,255,0.35)" }}>
